...
void objektumok(World* world) {
	
	load_model("models//gomb.obj", &world->object1.model);
	world->object1.texture = load_texture("textures//textura.png");
	init_object(&world->object1, 0, 0);





	world->room.ground = load_texture("textures//padlo.jpg");
	world->room.back = load_texture("textures//fal.jpg");
